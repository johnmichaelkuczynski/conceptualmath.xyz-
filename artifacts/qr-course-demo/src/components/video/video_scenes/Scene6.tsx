        ...
        {phase >= 2 && phase < 5 ? (
            ...
            <div className="space-y-4">
              ...
              >
                <div>
                  ...
                  <h4 className="font-serif text-lg text-primary mb-1">Homework 1.1 — Whole numbers, place value, operations</h4>
              ...
              >
                <div>
                  <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">Homework</div>
                  <h4 className="font-serif text-lg text-primary mb-1">Homework 1.2 — Factors, primes, negative numbers</h4>
                  <div className="text-sm text-muted-foreground">4 problems</div>
                </div>
                <div className="flex items-center space-x-6">
                  <div className="text-right">
          ...
          >
            ...
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 mb-6 relative overflow-hidden">
              ...
              <h3 className="font-medium text-lg mb-6 max-w-2xl text-foreground">Q1. Every whole number bigger than 1 has a unique prime factorization. Write the prime factorization of 12 using exponents.</h3>
              
              <div className="w-fit mb-6">
                <div className="text-xs text-muted-foreground mb-2">Your answer:</div>
                <div className="px-6 py-3 bg-muted/30 border border-border rounded-lg text-lg font-mono">2² × 3</div>
              </div>
                ...
                {phase >= 6 && (
                  ...
                  >
                    ...
                    <div className="text-sm text-blue-900 leading-relaxed">
                      <StreamingText text="Correct. 2² × 3 is exactly the prime factorization of 12 — the exponent records that the prime 2 appears twice. Clean use of exponent notation and the multiplication sign." delay={0} />
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
            ...
            <div className="bg-white border border-border rounded-xl shadow-sm p-8 opacity-50">
              <h3 className="font-medium text-lg mb-6 max-w-2xl text-foreground">Q2. Write 4072 in expanded form using powers of ten.</h3>
